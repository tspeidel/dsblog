...
#useR! 2016
![](https://media.licdn.com/mpr/mpr/AAEAAQAAAAAAAAlBAAAAJGVhNDBmODhjLTQ2ZDQtNGU2OS1iMjA4LWMwMWI4ZjE4MmUxMw.jpg)
...
In health research, the term "data driven" has negative connotations. Instead, we have a much more scientifically sound evidence-based approach.
...
This echos well-known statistician Frank Harrell: "Using the data to guide the data analysis is almost as dangerous as not doing so".
...
A great article on ProPublica on predictive sentences in the US.

*    More and more courses on ethics in data science are starting to emerge
*    Cathy O'Neal's book "Weapon of Math Destruction: How Big Data Increases Inequality and Threatens Democracy" is on my Amazon wish list.
*    Google provides one of the best explanations I have seen on the difficulty of making fair decisions. As Thomas Lumley writes: "You have to decide what summary of the difference you care about, because you can’t make them all the same. This is old news in medical diagnostics, but appears not to have been considered in some other areas".
...
And let's not fall into the trap of judging a Data Scientist by the **mathematical or algorithmic sophistication** of their arsenals. In the words of Kahneman, we would be substituting a question which we cannot answer with another one which we can answer.
